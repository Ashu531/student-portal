...
export const downloadTransaction = (state) => {
    ...
    let pdfContent = `
    <div style="font-family: 'Helvetica';padding: 50px 20px;background: #FFF; color: #000; font-size: 16px; width: 81.25%;heigth:100%;">
    <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
    <h1 style="font-weight: bolder;font-family: 'Helvetica';font-size:44px">
        RECEIPT
    </h1>
    ...
    <table>
        <tr style="text-align: left;font-family: 'Helvetica';">
    ...
    <h2 style="background-color: #fff; color: #000000; font-weight: bold;font-family: 'Helvetica';">Transactions Details</h2>
    <table style="border-collapse: collapse; width: 100%;font-family: 'Helvetica';">
        <tr>
    ...
    <h2 style="font-family: 'Helvetica';">Installments</h2>
